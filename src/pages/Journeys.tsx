      ...
      <main className="container max-w-lg mx-auto px-4 pt-8 animate-slide-up">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 mb-6">
            Start your journey today and build a deeper connection with your partner.
          </p>
          <Button 
            onClick={scrollToPathToTogether}
        ...
        <div id="path-to-together" className="scroll-mt-20">
