...
export function TodaysExerciseCard({
  ...
  return (
    <motion.div
      ...
      className="relative bg-[#EDE4D8] rounded-3xl border border-brand-primary/10 shadow-sm p-6 overflow-hidden"
    >
      ...
      <p className="font-serif italic text-[#2C1A14] text-xl leading-snug mb-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="bg-brand-primary text-white text-sm font-medium px-5 py-2.5 rounded-2xl hover:bg-brand-hover transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2"
        >
          Begin Exercise
        </motion.button>
      </div>
