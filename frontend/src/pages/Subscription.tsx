...
const plans = [
  {
    ...
    features: [
      ...
      { name: "Unlimited Path To Together journeys access", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "3 free Path To Together journeys included", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "All Path To Together journeys included", included: true },
...
// Path To Together packages data
const pathToTogetherPackages = [ // Renamed variable
  {
    id: "communication",
  ...
  {
    id: "bundle",
    title: "Complete Path To Together Bundle", // Updated title
    description: "All current and future Path To Together journeys at a discounted price", // Updated description
    price: 14.99,
    steps: 33,
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&h=500",
    popular: true,
...
const testimonials = [
  ...
  },
  {
    id: 2,
    name: "Jessica & David",
    text: "The Path To Together journeys are worth every penny. We completed the Communication journey and it's like we finally speak the same language.", // Updated text
...
export default function Subscription() {
  ...
  const handlePurchasePathToTogether = (journeyId: string) => { // Renamed handler
    toast.success(`Purchasing ${journeyId} Path To Together journey`); // Updated message
    // In a real app, this would redirect to a payment processor
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-24">
      ...
      <main className="container max-w-6xl mx-auto px-4 pt-6 animate-slide-up">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                ...
                Explore Path To Together Journeys
              </Button>
            </div>
          </div>
        </div>
        ...
        <section id="path-to-together" className="mb-16"> {/* Updated ID */}
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Path To Together Journeys</h2> {/* Updated title */}
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {pathToTogetherPackages.map((journey) => ( // Use renamed variable
              <Card key={journey.id} className="overflow-hidden">
                ...
                <CardContent className="pt-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button 
                      onClick={() => handlePurchasePathToTogether(journey.id)} // Use renamed handler
                      size="sm"
                    >
                      Purchase
                    </Button>
          ...
          <div className="mt-8 text-center">
            <Button variant="outline" size="lg" onClick={() => navigate("/path-to-together")}> {/* Updated navigation path */}
              View All Path To Together Journeys
            </Button>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">What are Path To Together Journeys?</CardTitle> {/* Updated title */}
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 dark:text-gray-400">
                  Path To Together Journeys are guided experiences designed to help you and your partner grow in specific areas of your relationship. Each journey consists of a series of activities, reflections, and conversations that build upon each other.
                </p>
              </CardContent>
            </Card>
